{{-- "Get Embed Code" modal — triggered with data-bs-toggle="modal" data-bs-target="#wfEmbed". --}}
            ...
            <div class="p-4">
                <div class="d-flex justify-content-between align-items-start mb-4">
                    <div>
                        ...
                        <div style="font-size:13.5px;color:#9A9AB8">Sarah's HVAC &middot; paste into any page of the client site.</div>
                    </div>
...
<pre id="wfEmbedSnippet" class="p-3 rounded-3 mb-3 wf-mono" style="background:#08081A;border:1px solid rgba(255,255,255,0.12);font-size:12px;line-height:1.85;color:#C6C6DC;white-space:pre-wrap;margin:0">&lt;iframe
